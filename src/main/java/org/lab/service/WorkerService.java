            ...
            if (existingWorker == null) {
                ...
                if (worker.getCoordinates() != null) {
                    ...
                    if (updatedCoordinates.getId() != null) {
                        ...
                        updatedCoordinates.setId(existingCoordinates.getId());
                ...
                if (worker.getOrganization() != null) {
                    ...
                    if (updatedOrganization.getId() != null) {
                        ...
                        if (updatedOrganization.getOfficialAddress() != null) {
                            ...
                            Address existingAddress = existingWorker.getOrganization().getOfficialAddress();

                            if (updatedAddress.getTown() != null) {
                                Location updatedTown = updatedAddress.getTown();
                                Location existingTown = existingWorker.getOrganization().getOfficialAddress().getTown();

                                updatedTown.setId(existingTown.getId());
                            ...
                            if (updatedAddress.getTown() == null) updatedAddress.setTown(updatedAddress.getTown());
                            if (updatedAddress.getStreet() == null) updatedAddress.setStreet(updatedAddress.getStreet());
                            if (updatedAddress.getZipCode() == null) updatedAddress.setZipCode(updatedAddress.getZipCode());
